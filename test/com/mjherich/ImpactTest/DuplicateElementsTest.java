...
class DuplicateElementsTest {
    ...
    public void FindDuplicateElementsTest() {
        ...
        assertEquals(expected3, d3.getDuplicates());
        ...
        assertEquals(expected4, d4.getDuplicates());
